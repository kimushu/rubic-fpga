...
entity nios2_fast_fpu_fpoint is
	port (
...
end entity nios2_fast_fpu_fpoint;

architecture rtl of nios2_fast_fpu_fpoint is
...
begin
	...
	nios2_fast_fpu_fpoint : component fpoint_wrapper
		generic map (
			useDivider => 0
		)
		port map (
...
end architecture rtl; -- of nios2_fast_fpu_fpoint
