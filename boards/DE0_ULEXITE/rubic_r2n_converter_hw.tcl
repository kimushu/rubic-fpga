...
# Wed Aug 13 11:26:07 JST 2014
# DO NOT MODIFY


# 
# rubic_r2n_converter "Rubic Rite to NiosII Instruction Converter" v1.1
# kimu_shu 2014.08.13.11:26:07
# 
# 
...
set_fileset_property SIM_VHDL TOP_LEVEL rubic_r2n_converter
...
# parameters
# 
add_parameter RITE_MEM_WIDTH INTEGER 25
set_parameter_property RITE_MEM_WIDTH DEFAULT_VALUE 25
set_parameter_property RITE_MEM_WIDTH DISPLAY_NAME RITE_MEM_WIDTH
set_parameter_property RITE_MEM_WIDTH TYPE INTEGER
set_parameter_property RITE_MEM_WIDTH UNITS None
set_parameter_property RITE_MEM_WIDTH ALLOWED_RANGES -2147483648:2147483647
set_parameter_property RITE_MEM_WIDTH HDL_PARAMETER true
...
set_interface_property nios2 maximumPendingReadTransactions 0
...
add_interface_port nios2 n_address address Input "(rite_mem_width+2) - 2"
add_interface_port nios2 n_read read Input 1
add_interface_port nios2 n_readdata readdata Output 32
